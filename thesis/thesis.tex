...
\newcommand{\projectTitle}{Benchmarking the Scalability Behaviour of MobilityDB and CrateDB}
...
\newcommand{\examinerb}{Prof.~Dr. Marc Toussaint}
\newcommand{\supervisor}{Tim Rese}
