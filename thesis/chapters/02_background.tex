...
(iii) \textbf{point reference data}, as described by \cite{cressieStatisticsSpatioTemporalData2015}, refers to measurements taken from a continuous ST process at specific locations that move over time (e.g., tracking surface temperature using weather balloons that drift through the atmosphere), and 
...
\cite{atluriSpatioTemporalDataMining2018}
