...
\begin{figure}[ht]
	...
	\end{tikzpicture}
	\caption{
		Load-generator issues synthetic spatio-temporal inserts and queries to a SUT consisting of one master and N worker nodes.
	}
	\label{fig:benchmark-design}
\end{figure}


\subsubsection{Metrics and Scenarios}
