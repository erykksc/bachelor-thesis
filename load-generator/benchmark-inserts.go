...
Waiting4Workers:
	...
	case CrateDB:
		// No additional processing needed for CrateDB - queries will use escooter_events directly
		logger.Info("CrateDB insert completed - queries will use escooter_events directly")
	}
}
